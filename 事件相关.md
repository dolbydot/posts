...
触发事件的实际目标
        - 举个例子：
假设页面中有 outer>inner>content 的结构，然后点击外层至内层的div，代码与结果如下：

![](http://upload-images.jianshu.io/upload_images/6851923-3f162a1a3bdfbcf5.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
